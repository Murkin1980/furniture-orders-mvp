...
| Commercial proposals | `[###-------] 30%` | Proposal Slice 1 complete: pure A4 template, safe data contract, automatic totals, JSON-to-HTML CLI, tests, and visual PDF verification | Add manager form and order-to-proposal mapper |
