...
| OCR and sketch recognition | `[#####-----] 50%` | Safe furniture-first recognition through draft/approved persistence contract complete | Protected manual recognition endpoint |
