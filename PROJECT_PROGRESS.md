...
| Admin/CRM visual refresh | 2026-06-21 | AdminLTE-inspired graphite shell and Golos Text applied to admin, native CRM, and public intake without new runtime dependencies | Validate the deployed manager workflow before further visual changes |
