...
| Commercial proposals | `[########--] 80%` | Manual generator ready: order-prefilled manager form, explicit pricing/terms, A4 preview, HTML download, and Print to PDF | Add D1 draft/version storage and approval history |
...
| Proposal Slice 4 | 2026-06-21 | Admin order action opens a responsive manager workspace with reference-only budget, multiple line items, explicit prices/terms, A4 preview, HTML download, and Print to PDF; 454 tests pass | Add versioned D1 draft/publish storage before calling proposals approved or sent |
