import { getCalculator } from "../../../src/calculators-core.js";
...
export async function onRequestGet(context) {
  ...
  try {
    const result = await getCalculator({
      db: context.env.DB,
      env: context.env,
    ...
    console.error("Calculator detail API failed", error);
    return jsonResponse(
      {
        success: false,
        error: "server_error",
        message: "Calculator was not loaded. Please try again later."
      },
      500
    );
  }
  ...
  return jsonResponse(
    {
      ...
      message: "Use GET /api/calculators/:id."
    },
    405,
    {
      Allow: "GET, OPTIONS"
