import { getVpsServices } from "../../../src/vps-control.js";
...
export async function onRequestGet(context) {
  ...
  try {
    ...
    console.error("VPS services API failed", error);
    return jsonResponse(
      {
        success: false,
        error: "server_error",
        message: "VPS services were not loaded. Please try again later."
      },
      500
    );
  }
  ...
  return jsonResponse(
    {
      ...
      message: "Use GET /api/vps/services."
    },
    405,
    {
      Allow: "GET, OPTIONS"
