import { getVpsHealth } from "../../../src/vps-control.js";
...
export async function onRequestGet(context) {
  ...
  try {
    ...
    console.error("VPS health API failed", error);
    return jsonResponse(
      {
        success: false,
        error: "server_error",
        message: "VPS health was not loaded. Please try again later."
      },
      500
    );
  }
  ...
  return jsonResponse(
    {
      ...
      message: "Use GET /api/vps/health."
    },
    405,
    {
      Allow: "GET, OPTIONS"
