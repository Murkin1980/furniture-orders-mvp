import { deployVpsSite } from "../../../../src/vps-control.js";
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    console.error("VPS deploy API failed", error);
    return jsonResponse(
      {
        success: false,
        error: "server_error",
        message: "VPS deploy was not started. Please try again later."
      },
      500
    );
  }
  ...
  return jsonResponse(
    {
      ...
      message: "Use POST /api/vps/deploy/site."
    },
    405,
    {
      Allow: "POST, OPTIONS"
