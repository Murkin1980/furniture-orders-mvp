import { getVpsDeployLogs } from "../../../../src/vps-control.js";
...
export async function onRequestGet(context) {
  ...
  try {
    ...
    const result = await getVpsDeployLogs({
      env: context.env,
      query: {
    ...
    console.error("VPS deploy logs API failed", error);
    return jsonResponse(
      {
        success: false,
        error: "server_error",
        message: "VPS deploy logs were not loaded. Please try again later."
      },
      500
    );
  }
  ...
  return jsonResponse(
    {
      ...
      message: "Use GET /api/vps/deploy/logs."
    },
    405,
    {
      Allow: "GET, OPTIONS"
