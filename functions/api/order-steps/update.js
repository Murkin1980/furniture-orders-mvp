import { updateOrderStep } from "../../../src/orders-core.js";
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    console.error("Order step update API failed", error);
    return jsonResponse(
      {
        success: false,
        error: "server_error",
        message: "Order step was not updated. Please try again later."
      },
      500
    );
  }
  ...
  return jsonResponse(
    {
      ...
      message: "Use POST /api/order-steps/update."
    },
    405,
    {
      Allow: "POST, OPTIONS"
