import { deploySite } from "../../../../src/sites-core.js";
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    console.error("Site deploy API failed", error);
    return jsonResponse(
      {
        success: false,
        error: "server_error",
        message: "Site deploy was not started. Please try again later."
      },
      500
    );
  }
  ...
  return jsonResponse(
    {
      ...
      message: "Use POST /api/sites/:id/deploy."
    },
    405,
    {
      Allow: "POST, OPTIONS"
