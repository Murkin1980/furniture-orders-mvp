import { getSiteStatus } from "../../../../src/sites-core.js";
...
export async function onRequestGet(context) {
  ...
  try {
    ...
    console.error("Site status API failed", error);
    return jsonResponse(
      {
        success: false,
        error: "server_error",
        message: "Site status was not loaded. Please try again later."
      },
      500
    );
  }
  ...
  return jsonResponse(
    {
      ...
      message: "Use GET /api/sites/:id/status."
    },
    405,
    {
      Allow: "GET, OPTIONS"
