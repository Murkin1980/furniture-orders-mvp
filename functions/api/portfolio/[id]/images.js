import { addPortfolioImages } from "../../../../src/portfolio-core.js";
...
export async function onRequestPost(context) {
  ...
  try {
    const result = await addPortfolioImages({
      db: context.env.DB,
      env: context.env,
    ...
    console.error("Portfolio images API failed", error);
    return jsonResponse(
      {
        success: false,
        error: "server_error",
        message: "Portfolio images were not saved. Please try again later."
      },
      500
    );
  }
  ...
  return jsonResponse(
    {
      ...
      message: "Use POST /api/portfolio/:id/images."
    },
    405,
    {
      Allow: "POST, OPTIONS"
